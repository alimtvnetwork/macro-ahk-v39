...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/macro-ahk-v35/releases/download/v3.4.2/install.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v35/releases/download/v3.4.2/install.sh | bash
```
