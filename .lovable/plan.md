...
| 2c-storage | **chrome.storage.local PascalCase migrator** — rewrite already-persisted projects on extension upgrade; bump storage schema version | Medium | `mem://standards/pascalcase-json-keys` |
